            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2 text-sm">
                <div className="flex justify-between">
                  ...
                  {user.merchantDetails?.tinNumber ? (
                    <a
                      href={user.merchantDetails.tinNumber}
                      target="_blank"
                ...
                <div className="flex justify-between">
                  ...
                  {user.merchantDetails?.nationalId ? (
                    <a
                      href={user.merchantDetails.nationalId}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:underline"
                    >
                ...
                <div className="flex justify-between">
                  ...
                  <span>{user.merchantDetails?.account?.name || "Not provided"}</span>
                </div>

                <div className="flex justify-between">
                  <span className="font-medium text-muted-foreground">Account Number:</span>
                  <span>{user.merchantDetails?.account?.number || "Not provided"}</span>
                </div>

                <div className="flex justify-between">
                  <span className="font-medium text-muted-foreground">Bank Code:</span>
                  <span>{user.merchantDetails?.account?.bankCode || "Not provided"}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-wrap justify-end gap-2 pt-2">
        {!user.isDeleted ? (
          <>
            ...
            {user.role === "merchant" && user.approvalStatus === "pending" && (
              <>
                <Button
                  variant="default"
                  onClick={() => {
