...
export function Footer() {
  ...
  return (
    <footer className={`mt-auto border-t ${isFullWidthPage ? "ml-0" : "ml-0 md:ml-[calc(var(--sidebar-width)-20px)]"}`}>
      {/* Top section with gradient background */}
      <div className={`bg-gradient-to-r ${getGradientColors()} text-white py-8 sm:py-12`}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Stay Connected</h3>
              <p className="text-sm sm:text-base opacity-90 mb-4">
                Subscribe to our newsletter for the latest updates, news, and special offers.
              </p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mb-4">
                Empowering businesses with advanced marketplace management solutions since 2020.
              </p>
