...
export function AuctionDetailsDialog({ auction, open, onOpenChange }: AuctionDetailsDialogProps) {
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      console.log("Rejecting auction:", auction.id, { reason: rejectionCategory, description: rejectionReason });
  ...
  return (
    <>
      <Dialog open={open && !showRejectDialog && !showApproveDialog} onOpenChange={onOpenChange}>
                ...
                <div className="mt-4 border border-red-200 bg-red-50 p-4 rounded-md">
                  ...
                  <div className="text-sm mt-2 text-red-700">
                    <div className="font-medium">
                      Category: {auction.banReason.reason.replace("_", " ").replace(/\b\w/g, (c) => c.toUpperCase())}
                    </div>
      ...
      <Dialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to approve this auction? This will make it active and allow bidding to begin.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
